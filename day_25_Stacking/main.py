...
basemodel = [
    ...
    ("Catboost", CatBoostClassifier(iterations=100, depth=5, learning_rate=0.1,verbose = 0, random_state=1))
]
clf = StackingClassifier(estimators=basemodel, final_estimator=LogisticRegression())
